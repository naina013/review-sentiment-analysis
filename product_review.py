...
b = Button(root,text='submit',bg='red',width=70,height=5,command=lambda:printtext(root))
b.pack(side='bottom')
root.mainloop()
...
driver = webdriver.PhantomJS(executable_path="C:\\phantomjs\\bin\\phantomjs",service_args=['--load-images=no'])
